      ...
      <main className="container py-12 space-y-12" id="main-content">
        <section className="py-12 md:py-24 space-y-8">
          <div className="space-y-4 text-center">
            <Skeleton className="w-32 h-6 bg-white/[0.04] border border-white/[0.04] rounded-full mx-auto" />
        ...
        <section className="py-12 space-y-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <Skeleton className="h-8 w-48 bg-white/[0.04] border border-white/[0.04] rounded" />
            <Skeleton className="h-10 w-full md:w-80 bg-white/[0.04] border border-white/[0.04] rounded" />
          </div>
