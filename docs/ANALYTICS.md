...
Both platforms respect cookie consent (`src/components/cookie-consent.tsx`).

### Tracking Library

**Location:** `src/lib/analytics.ts` (25+ functions)
...
| File                                 | Change                                    |
| ------------------------------------ | ----------------------------------------- |
| `src/lib/motion.ts`                  | Optimized Framer Motion exports           |
| `src/lib/ui-components.ts`           | Centralized Radix UI exports              |
| `src/components/dynamic-imports.tsx` | 10+ lazy-loaded components                |
| `src/app/layout.tsx`                 | Resource hints (DNS prefetch, preconnect) |
