...
const targetRoots = [join(repoRoot, ".agents", "skills"), join(repoRoot, ".claude", "skills")]
    ...
    if (entry.computedHash && entry.computedHash !== computedHash) {
      if (updateMode) {
        ...
        process.stdout.write(
          `HASH MISMATCH (lock=${entry.computedHash.slice(0, 12)}… actual=${computedHash.slice(0, 12)}…) `,
        )
      }
