...
// Post metadata
export type PostMetadata = Pick<MediumPost, "id" | "title" | "slug" | "pubDate" | "readingTime">
```
...
export type ApiResponse<T> =
  { status: "success"; data: T } | { status: "error"; error: string } | { status: "loading" }
