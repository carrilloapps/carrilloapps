        ...
        {shareLinks.map((social, index) => (
          ...
          >
            ...
            >
              ...
              >
                {social.icon}
                <span className="hidden text-xs font-medium sm:inline">{social.name}</span>
              </a>
            </Button>
          </motion.div>
        ))}
          ...
          >
            {copied ? (
              <>
                ...
                <span className="hidden text-xs font-medium sm:inline">Copiado</span>
              </>
            ) : (
              <>
                <Link2 className="h-4 w-4" />
                <span className="hidden text-xs font-medium sm:inline">Copiar link</span>
              </>
            )}
          </Button>
        </motion.div>
