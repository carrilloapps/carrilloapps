...
export const Logo = memo(function Logo({
  ...
  const inner = <BrandWordmark size={size} textClassName={textClassName} showMark={showMark} />
  ...
  if (animationLevel === "none") {
    return (
      <div className={className}>
        <Link
          href={href}
          className={`${linkClassName} inline-flex items-center rounded-md focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 focus:ring-offset-black focus:outline-none`}
        >
          {inner}
        </Link>
      </div>
