...
>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("relative space-y-4 p-6", className)} {...props} />
))
 ...
 */
export const SubtleSurface = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("surface-card-subtle", className)} {...props} />
  ),
)
