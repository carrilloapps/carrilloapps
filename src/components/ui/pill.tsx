...
const pillVariants = cva(
  "inline-flex w-fit items-center gap-2 rounded-full border font-medium whitespace-nowrap transition-colors",
  {
    variants: {
      variant: {
        /** Section eyebrows / brand accents. */
        eyebrow:
          "border-emerald-500/30 bg-emerald-500/10 tracking-[0.18em] text-emerald-400 uppercase",
        /** Secondary meta (e.g. a period "2024 — Presente"). */
        accent: "border-blue-500/30 bg-blue-500/10 tracking-[0.14em] text-blue-300 uppercase",
        /** Neutral uppercase label. */
        neutral: "border-white/10 bg-white/5 tracking-[0.14em] text-zinc-300 uppercase",
        /** Tech tags / soft chips (no uppercase). */
        tag: "border-white/10 bg-white/[0.04] text-zinc-300",
      },
      size: {
