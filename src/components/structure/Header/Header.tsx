...
export default function Header({ simple }: Props) {
  ...
  const { t, i18n: { changeLanguage, language } } = useTranslation(); // Hook de traducción
  ...
  // Obtención de textos traducidos
  ...
  const handleLanguageChange = (lang: string) => {
    changeLanguage(lang);
    setLanguageMenuOpen(false); // Cerrar el menú de idiomas al cambiar de idioma
  };

  // Mapa de idiomas a sus banderas
                ...
                <div className="relative inline-block text-left">
                  <div>
                    <button
                      ...
                      aria-expanded="true"
                    >
                      <img src={flags[language]} alt={language} className="h-5 w-5 mr-2" /> {/* Mostrar la bandera actual */}
              ...
              <nav className="md:hidden bg-[#252525] text-white transition duration-150">
                <div className="flex justify-center gap-4 p-2">
                  ...
                  <button
                    ...
                    className={`flex items-center ${language === 'es' ? 'border-2 border-orange-200 rounded' : ''}`}
                    aria-label="Español"
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center ${language === 'en' ? 'border-2 border-orange-200 rounded' : ''}`}
                    aria-label="English"
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center ${language === 'pt' ? 'border-2 border-orange-200 rounded' : ''}`}
