...
export default function Footer() {
  return (
    <div className="my-10 flex flex-col text-center items-center text-neutral-300 max-w-[400px]">
      <Logo />
      <a href="/legal" className="hover:text-orange-200 mt-4">&copy; 2015 - {(new Date()).getFullYear()} <span className="text-orange-200">carrillo.app by José Carrillo</span> v3</a>
