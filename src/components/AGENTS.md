...
**Location**: `src/components/dynamic-imports.tsx`
...
export const DynamicMyHeavyComponent = dynamic(
  ...
  {
    loading: () => <div className="h-48 animate-pulse rounded-lg bg-zinc-900/50"></div>,
    ssr: false,
  },
)
```
...
**Location**: `src/components/page-hero.tsx`
...
**Location**: `src/components/page-hero-split.tsx`
...
<PageHeroSplit
  ...
  description={
    <>
      <p className="leading-relaxed text-zinc-400">First paragraph...</p>
      <p className="leading-relaxed text-zinc-400">Second paragraph...</p>
    </>
  }
...
**Location**: `src/components/dynamic-background.tsx`
...
**Location**: `src/components/unified-loading.tsx`
...
**Location**: `src/components/page-loading-context.tsx`
...
**Location**: `src/components/json-ld.tsx`
...
Located in `src/components/ui/` directory. Built on Radix UI primitives.
...
```tsx
<Card className="group border-zinc-800 bg-zinc-900/50 transition-all duration-300 hover:border-blue-500/30">
...
```tsx
<Badge className="border border-emerald-500/30 bg-gradient-to-r from-emerald-600/20 to-teal-600/20 text-emerald-400">
  New
</Badge>
```
