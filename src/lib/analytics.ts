...
export function trackFormFieldInteraction(formName: string, fieldName: string) {
 ...
 */
export function trackDownload(fileName: string, fileType: string, fileUrl: string) {
 ...
 */
export function trackEngagement(contentType: string, contentName: string, timeSpent: number) {
 ...
 */
export function trackError(errorMessage: string, errorLocation: string, fatal: boolean = false) {
 ...
 */
export function trackNewsletterSignup(email: string, source: string, success: boolean) {
 ...
 */
export function trackBlogPostView(postTitle: string, postCategory: string, readingTime?: number) {
...
export function trackBlogPostShare(postTitle: string, sharePlatform: string) {
