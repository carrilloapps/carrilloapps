...
export const featuredProjects: FeaturedProject[] = [
  {
    ...
    name: "hfo",
    description:
      "TUI fullscreen y CLI headless para descubrir, instalar y gestionar modelos GGUF de Hugging Face sobre Ollama.",
    platform: "github",
    ...
    customDescription:
      "Detecta tu hardware y auto-ajusta los parámetros del modelo. Distribuido en npm como hfo-cli, con interfaz interactiva en Ink y modo CLI scripteable.",
  },
  {
    id: "zefer",
    name: "zefer",
    description:
      "Herramienta de cifrado end-to-end y zero-knowledge que corre 100% en tu navegador — el servidor nunca ve tus datos.",
    platform: "github",
    ...
    customDescription:
      "Cifrado AES-256-GCM del lado del cliente con Web Crypto API. Instalable como PWA y acompañada por su CLI oficial (zefer-cli) para flujos desde la terminal.",
  },
  {
    id: "bcv-exchange-rate",
    name: "bcv-exchange-rate",
    description:
      "Librería Node.js y servidor MCP para consultar tasas oficiales del BCV (Venezuela), TRM (Colombia) y PTAX (Brasil).",
    platform: "github",
