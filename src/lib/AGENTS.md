...
**Location**: `src/lib/ui-components.ts`
...
**Always use from `src/lib/ui-components.ts`:**
...
**Location**: `src/lib/language-detector.ts`
...
Used in `src/components/blog-content-renderer.tsx`:
...
**Location**: `src/lib/rss-service.ts`
...
**Location**: `src/lib/rss-client.ts`
...
const getCached = unstable_cache(async () => data, ["key"], { revalidate: 3600, tags: ["tag"] })
```
