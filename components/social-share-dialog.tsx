...
export function SocialShareDialog({ open, onOpenChange, title, url }: SocialShareDialogProps) {
      ...
      <DialogContent className="sm:max-w-md bg-zinc-900 border-zinc-800 text-white">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="pt-4 border-t border-zinc-800">
            <p className="text-sm text-zinc-400 mb-2">O copia el enlace</p>
            <div className="flex gap-2">
              <input
                type="text"
                value={url}
                readOnly
                className="flex-1 px-3 py-2 bg-zinc-800/50 border border-zinc-700/50 rounded-lg text-sm text-zinc-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
              />
              <Button
